...
func (e *FileUploadAndDownloadRouter) InitRouter(Router *gin.RouterGroup) {
	fileUploadAndDownloadRouter := Router.Group("fileUploadAndDownload")
	exaFileUploadAndDownloadApi := api.ApiGroupApp.SystemApi.FileUploadAndDownloadApi
	{
		fileUploadAndDownloadRouter.POST("uploadWillDelete", exaFileUploadAndDownloadApi.UploadWillDelete) //自动删除
