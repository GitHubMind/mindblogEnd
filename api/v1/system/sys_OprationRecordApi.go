...
func (s *OperationRecordApi) DeleteSysOperationRecordByIds(c *gin.Context) {
	...
	if err := operationRecordService.DeleteSysOperationRecordByIds(IDS); err != nil {
		global.GM_LOG.Error("批量删除失败!", zap.Error(err))
...
func (s *OperationRecordApi) FindSysOperationRecord(c *gin.Context) {
	...
	if err := lib.Verify(sysOperationRecord, lib.IdVerify); err != nil {
...
// @accept application/json
// @Produce application/json
// @Param data query system.SysOperationRecordSearch true "页码, 每页大小, 搜索条件"
...
func (s *OperationRecordApi) GetSysOperationRecordList(c *gin.Context) {
	var pageInfo system.SysOperationRecordSearch
